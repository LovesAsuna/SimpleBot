...
interface YuanShenPool : CardPool {
    ...
    object GongZiPool : YuanShenPool {
        ...
        override val normalFour = arrayOf("重云", "砂糖", "行秋", "诺艾尔", "班尼特", "菲谢尔", "香菱", "雷泽", "芭芭拉", "弓藏", "祭礼弓", "绝弦", "西风猎弓", "昭心", "祭礼残章", "流浪乐章", "西风秘典", "西风长枪", "匣里灭辰", "雨裁", "祭礼大剑", "钟剑", "西风大剑", "匣里龙吟", "祭礼剑", "笛剑", "西风剑")
    ...
    object SkyWings : YuanShenPool {
        ...
        override val normalFour = arrayOf("砂糖", "重云", "诺艾尔", "班尼特", "菲谢尔", "凝光", "行秋", "北斗", "香菱", "安柏", "雷泽", "凯亚", "芭芭拉", "丽莎", "祭礼弓", "绝弦", "西风猎弓", "祭礼残章", "流浪乐章", "西风秘典", "匣里灭辰", "祭礼大剑", "钟剑", "西风大剑", "匣里龙吟", "祭礼剑", "西风剑")
