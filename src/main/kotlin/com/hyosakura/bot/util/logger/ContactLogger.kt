package com.hyosakura.bot.util.logger
...
fun CommandSender.verbose(message: String) {
    ...
    com.hyosakura.bot.Main.logger.verbose(message)
}

fun CommandSender.debug(message: String) {
    ContactLogger.contact = this.subject!!
    com.hyosakura.bot.Main.logger.debug(message)
}

fun CommandSender.warning(message: String) {
    ContactLogger.contact = this.subject!!
    com.hyosakura.bot.Main.logger.warning(message)
}

fun CommandSender.info(message: String) {
    ContactLogger.contact = this.subject!!
    com.hyosakura.bot.Main.logger.info(message)
}

fun CommandSender.error(message: String) {
    ContactLogger.contact = this.subject!!
    com.hyosakura.bot.Main.logger.error(message)
}
